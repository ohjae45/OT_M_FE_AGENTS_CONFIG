...
│   ├── .card__header         (flex, justify: space-between, align: center)
│   │   ├── .card__title      (font: 600 16px/24px, color: var(--text-primary))
│   │   └── .card__action     (icon-button 28x28)
│   ├── .card__body           (font: 400 14px/20px, color: var(--text-secondary))
│   └── .card__footer         (flex, gap: 8px)
